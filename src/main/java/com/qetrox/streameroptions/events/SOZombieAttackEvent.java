...
public class SOZombieAttackEvent {
    /** Spawn a zombie
     * @param p Streamer
    ...
    public static void response(Player p, String eventRedeemedBy) {
        Bukkit.getScheduler().runTask(plugin, new Runnable() {
            ...
            public void run() {
                ...
                p.sendMessage(ChatColor.LIGHT_PURPLE + "[Streamer Options] " + ChatColor.GOLD + eventRedeemedBy + ChatColor.WHITE + " has activated " + ChatColor.GOLD + "Zombie Attack");
            }
        });
    }
}
